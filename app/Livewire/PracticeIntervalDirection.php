...
class PracticeIntervalDirection extends Component
{
    ...
    public const POOL_TO_SEMITONES = [
        'm2' => 1,  'M2' => 2,  'm3' => 3,  'M3' => 4,
        'P4' => 5,  'TT' => 6,  'P5' => 7,  'm6' => 8,
    ...
    public function mount($practices)
    {
        ...
        if (! empty($settings)) {
            ...
            // No explicit octave: the generator keeps both notes inside the
            ...
            $generated = $raw->map(function ($q, $i) {
                $q->id = $i + 1;
    ...
    {
        $practiceId = Practice::where('slug', 'interval-direction-practice')->value('id');
