...
class HarmonicIntervalPractice extends Model
{
    ...
    public static function schema() {
        return [
            'type' => 'object',
            'description' => 'Harmonic Interval Practice Question. Two notes are played simultaneously and the student must identify the interval name.',
            'properties' => [
                'interval' => [
                    'type' => 'string',
