...
class IntervalConstructionPractice extends Model
{
    ...
    public static function schema() {
        return [
            'type' => 'object',
            'description' => 'Interval Construction Practice Question. Given a starting note and an interval name, the student must identify the second note that completes the interval.',
            'properties' => [
                'interval' => [
                    'type' => 'string',
                    ...
                    'description' => 'The interval name to construct',
                ],
                'note1' => [
                    'type' => 'string',
                    'description' => 'The starting note (e.g., C, D, E, F, G, A, B)'
                ],
                'note2' => [
                    'type' => 'string',
                    'description' => 'The correct answer note that completes the interval (e.g., C, D, E, F, G, A, B)'
                ],
                'octave' => [
                    'type' => 'string',
