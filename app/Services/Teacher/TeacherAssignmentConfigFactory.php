...
class TeacherAssignmentConfigFactory
{
    ...
    public const CLEFS = ['treble', 'bass'];
    ...
    private function preset(string $type, string $difficulty): array
    {
        ...
        return match ($type) {
            ...
            'melodic-interval-practice', 'harmonic-interval-practice' => match ($difficulty) {
                'beginner' => ['allowed_intervals' => ['Major 2nd', 'Major 3rd', 'Perfect 5th', 'Perfect Octave'], 'allowed_notes' => ['C', 'D', 'E', 'F', 'G'], 'clef' => 'treble'],
                'intermediate' => ['allowed_intervals' => ['Minor 2nd', 'Major 2nd', 'Minor 3rd', 'Major 3rd', 'Perfect 4th', 'Perfect 5th', 'Major 6th', 'Perfect Octave'], 'allowed_notes' => self::NATURAL_NOTES, 'clef' => 'treble'],
                'advanced' => ['allowed_intervals' => array_keys(MusicTheoryService::INTERVAL_SEMITONES), 'allowed_notes' => self::NATURAL_NOTES, 'clef' => 'treble'],
            },
            ...
            'interval-construction-practice' => match ($difficulty) {
                'beginner' => ['allowed_intervals' => ['Major 2nd', 'Major 3rd', 'Perfect 5th'], 'allowed_root_notes' => ['C', 'D', 'E', 'F', 'G'], 'clef' => 'treble'],
                'intermediate' => ['allowed_intervals' => ['Minor 2nd', 'Major 2nd', 'Minor 3rd', 'Major 3rd', 'Perfect 4th', 'Perfect 5th'], 'allowed_root_notes' => self::NATURAL_NOTES, 'clef' => 'treble'],
                'advanced' => ['allowed_intervals' => ['Minor 2nd', 'Major 2nd', 'Minor 3rd', 'Major 3rd', 'Perfect 4th', 'Tritone', 'Perfect 5th', 'Minor 6th', 'Major 6th', 'Minor 7th', 'Major 7th', 'Perfect Octave'], 'allowed_root_notes' => self::NATURAL_NOTES, 'clef' => 'treble'],
            },
            'chord-practice' => match ($difficulty) {
                'beginner' => ['allowed_chord_types' => ['Major', 'Minor'], 'allowed_root_notes' => ['C', 'F', 'G'], 'voicing' => 'block', 'include_inversions' => false, 'clef' => 'treble', 'distractor_pool' => ['Augmented', 'Diminished', 'Minor', 'Major']],
            ...
            'scale-practice' => match ($difficulty) {
                'beginner' => ['allowed_scale_types' => ['Major', 'Natural Minor'], 'allowed_root_notes' => ['C', 'G', 'F'], 'direction' => 'ascending', 'clef' => 'treble', 'distractor_pool' => ['Major', 'Natural Minor', 'Major Pentatonic']],
            ...
            'rhythm-practice' => match ($difficulty) {
                'beginner' => ['time_signatures' => ['4/4'], 'allowed_note_values' => ['quarter', 'half', 'whole'], 'tempo_range' => [72, 84], 'bars' => 1, 'rhythm_difficulty' => 'easy'],
            ...
            'melodic-dictation' => match ($difficulty) {
                'beginner' => ['note_pool' => ['C4', 'D4', 'E4', 'F4', 'G4'], 'melody_length' => 3, 'clef' => 'treble', 'key_signatures' => ['C'], 'tempo_range' => [57, 63], 'include_rhythm' => false, 'bars' => 1, 'difficulty' => 'beginner'],
                'intermediate' => ['note_pool' => ['C4', 'D4', 'E4', 'F4', 'G4', 'A4', 'B4', 'C5'], 'melody_length' => 5, 'clef' => 'treble', 'key_signatures' => ['C', 'G', 'F'], 'tempo_range' => [63, 76], 'include_rhythm' => false, 'bars' => 1, 'difficulty' => 'intermediate'],
                'advanced' => ['note_pool' => ['G3', 'A3', 'B3', 'C4', 'D4', 'E4', 'F4', 'G4', 'A4', 'B4', 'C5', 'D5'], 'melody_length' => 7, 'clef' => 'treble', 'key_signatures' => ['C', 'G', 'D', 'F', 'Bb'], 'tempo_range' => [69, 84], 'include_rhythm' => false, 'bars' => 2, 'difficulty' => 'advanced'],
            },
        };
    }
    ...
    private function applyOverrides(string $type, array $config, array $overrides): array
    {
        foreach ($overrides as $key => $value) {
            ...
            $config = match ($key) {
                ...
                'allowed_note_values' => $this->overrideList($config, $key, $value, self::NOTE_VALUES, $type, ['rhythm-practice']),
                'time_signatures' => $this->overrideList($config, $key, $value, self::TIME_SIGNATURES, $type, ['rhythm-practice']),
                'clef' => $this->overrideScalar($config, $key, $value, self::CLEFS, $type, ['interval-direction-practice', 'interval-comparison-practice', 'melodic-dictation', 'chord-practice', 'scale-practice']),
                ...
                'direction' => $this->overrideScalar($config, $key, $value, ['ascending', 'descending'], $type, ['scale-practice']),
