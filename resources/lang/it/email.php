...
return [
    ...
    'first_exercise_teacher' => [
        'subject' => '{{user_first_name}}, aggiungi il tuo primo allievo 👥',
        'preheader' => 'La tua dashboard da insegnante è pronta — mancano solo gli allievi',
        'title' => 'Pronto per il tuo primo allievo?',
        'p1' => 'Hai aperto il tuo account insegnante su {{app_name}} qualche giorno fa, ma non si è ancora iscritto nessun allievo. Invitarne uno richiede un minuto: manda il link e il suo studio, i compiti e i progressi arriveranno direttamente nella tua dashboard.',
        'btn' => '👥 Invita il tuo primo allievo',
        'btn_sub' => 'Un link. I progressi compaiono da soli.',
        'p2' => 'Insegni già altrove? Porta qui i tuoi allievi attuali: loro continuano a esercitarsi, tu ottieni i dati.',
    ],

    'first_exercise_school' => [
        'subject' => '{{user_first_name}}, aggiungi il tuo primo insegnante 🏫',
        'preheader' => 'La dashboard della tua scuola è pronta — mancano solo gli insegnanti',
        'title' => 'Pronto per il tuo primo insegnante?',
        'p1' => 'Hai aperto l\'account scuola su {{app_name}} qualche giorno fa, ma nell\'organico non c\'è ancora nessun insegnante. Invitane uno e i suoi allievi, le lezioni e i progressi confluiranno automaticamente nella dashboard della tua scuola.',
        'btn' => '🏫 Invita il tuo primo insegnante',
        'btn_sub' => 'Un link. Il suo studio si collega alla tua scuola.',
        'p2' => 'Ogni insegnante che aggiungi porta con sé i suoi allievi: tutta la scuola in un\'unica vista.',
    ],

    'learning_path_teacher' => [
        'subject' => 'I tuoi allievi ti aspettano, {{user_first_name}} 📋',
        'preheader' => 'Dai un\'occhiata al tuo studio — i progressi si accumulano',
        'title' => 'Il tuo studio è andato avanti senza di te',
        'p1' => 'Dalla tua parte è stata una settimana tranquilla, ma i tuoi allievi hanno continuato a esercitarsi. Le loro sessioni, la precisione e le serie ti aspettano nella dashboard — e spesso basta un solo compito per far superare a qualcuno un momento di stallo.',
        'btn' => '📋 Controlla i tuoi allievi',
        'btn_sub' => 'Guarda chi migliora e chi è bloccato.',
        'p2' => '🎯 Un compito breve inviato oggi vale più di uno lungo inviato il mese prossimo.',
    ],

    'learning_path_school' => [
        'subject' => 'La tua scuola è andata avanti, {{user_first_name}} 📋',
        'preheader' => 'I tuoi insegnanti e i tuoi allievi sono stati attivi',
        'title' => 'La tua scuola è andata avanti senza di te',
        'p1' => 'Non ti fai vedere da una settimana, ma i tuoi insegnanti e i loro allievi hanno continuato a esercitarsi. Attività delle lezioni, progressi degli allievi e organico degli insegnanti sono aggiornati nella dashboard della tua scuola.',
        'btn' => '📋 Apri la dashboard della scuola',
        'btn_sub' => 'Ogni insegnante, ogni allievo, un\'unica vista.',
        'p2' => '🎯 Un\'occhiata settimanale di solito basta per capire chi ha bisogno di supporto.',
    ],

    'weekly_progress_teacher' => [
        'subject' => 'Il tuo studio questa settimana: {{weekly_sessions}} sessioni 📈',
        'preheader' => 'Come si sono esercitati i tuoi allievi questa settimana',
        'title' => 'Il tuo studio questa settimana',
        'subtitle' => 'Ecco come si sono esercitati i tuoi allievi questa settimana, {{user_first_name}}. Tu hai inviato {{weekly_assignments}} nuovi compiti.',
        'm1' => 'Allievi',
        'm2' => 'Sessioni',
        'm3' => 'Precisione',
        'btn' => '📈 Apri la dashboard insegnante',
        'btn_sub' => 'Scopri chi è migliorato e chi ha bisogno di una spinta.',
    ],

    'weekly_progress_school' => [
        'subject' => 'La tua scuola questa settimana: {{weekly_sessions}} sessioni 📈',
        'preheader' => 'Come si è esercitata la tua scuola questa settimana',
        'title' => 'La tua scuola questa settimana',
        'subtitle' => 'Ecco la settimana nella tua scuola, {{user_first_name}} — precisione media {{weekly_accuracy}}.',
        'm1' => 'Insegnanti',
        'm2' => 'Allievi',
        'm3' => 'Sessioni',
        'btn' => '📈 Apri la dashboard della scuola',
        'btn_sub' => 'Dettagli per insegnante e per allievo all\'interno.',
    ],

    're_engagement_teacher' => [
        'subject' => 'Il tuo account insegnante è ancora qui, {{user_first_name}} 🎓',
        'preheader' => 'I tuoi allievi, i compiti e il profilo sono al sicuro',
        'title' => 'È tutto dove l\'hai lasciato',
        'p1' => 'È passato un po\' da quando hai aperto la tua dashboard insegnante su {{app_name}}. L\'elenco degli allievi, i compiti, il profilo e le recensioni sono esattamente come li hai lasciati: niente è scaduto, niente è andato perso.',
        'btn' => '🎓 Torna a insegnare',
        'btn_sub' => 'Riprendi il tuo studio con un clic.',
    ],

    're_engagement_school' => [
        'subject' => 'Il tuo account scuola è ancora qui, {{user_first_name}} 🏫',
        'preheader' => 'I tuoi insegnanti, allievi e impostazioni sono al sicuro',
        'title' => 'È tutto dove l\'hai lasciato',
        'p1' => 'È passato un po\' da quando hai aperto la dashboard della tua scuola su {{app_name}}. L\'organico degli insegnanti, i dati degli allievi e il profilo della scuola sono esattamente come li hai lasciati: niente è scaduto, niente è andato perso.',
        'btn' => '🏫 Torna alla tua scuola',
        'btn_sub' => 'Riprendi da dove la tua scuola si era fermata.',
    ],

    'premium_upsell_teacher' => [
        'subject' => 'Il tuo studio ha superato il piano gratuito, {{user_first_name}} ⭐',
        'preheader' => 'Prenotazioni, pagamenti e compiti illimitati con Premium',
        'badge' => '⭐ PREMIUM INSEGNANTE',
        'title' => 'Stai costruendo uno studio vero',
        'subtitle' => 'Ciao {{user_first_name}} — hai allievi che si esercitano con regolarità. Ecco cosa aggiunge Premium allo studio che hai già costruito:',
        'f1_t' => 'Calendario di prenotazione online',
        'f1_d' => 'Gli allievi prenotano le lezioni nei tuoi orari liberi. Niente scambi di messaggi.',
        'f2_t' => 'Compiti illimitati',
        'f2_d' => 'Invia tutti gli esercizi personalizzati di cui i tuoi allievi hanno bisogno, senza limite giornaliero.',
        'f3_t' => 'Un profilo pubblico in evidenza',
        'f3_d' => 'Sali nella directory degli insegnanti e ricevi pagamenti dal tuo profilo.',
        'btn' => '⭐ Vedi i piani insegnante',
        'btn_sub' => 'Pensato per chi insegna già.',
        'p2' => 'Non è ancora il momento? Il tuo account gratuito continua a funzionare esattamente come oggi.',
    ],

    'premium_upsell_school' => [
        'subject' => 'La tua scuola ha superato il piano gratuito, {{user_first_name}} ⭐',
        'preheader' => 'Insegnanti illimitati, identità della scuola e report con Premium',
        'badge' => '⭐ PREMIUM SCUOLA',
        'title' => 'La tua scuola sta crescendo',
        'subtitle' => 'Ciao {{user_first_name}} — i tuoi insegnanti sono attivi e i loro allievi si esercitano. Ecco cosa aggiunge Premium:',
        'f1_t' => 'Insegnanti illimitati nell\'organico',
        'f1_d' => 'Aggiungi tutto il corpo docente senza limiti per posto.',
        'f2_t' => 'Report per tutta la scuola',
        'f2_d' => 'Confronta insegnanti e gruppi ed esporta i progressi per le famiglie.',
        'f3_t' => 'Profilo scuola con la tua identità',
        'f3_d' => 'Il tuo logo, la tua pagina e una posizione migliore nella directory delle scuole.',
        'btn' => '⭐ Vedi i piani scuola',
        'btn_sub' => 'Pensato per scuole con un organico vero.',
        'p2' => 'Non è ancora il momento? Il tuo account gratuito continua a funzionare esattamente come oggi.',
    ],
