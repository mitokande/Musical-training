...
/*
 * Mensajes de validación de Laravel en español.
 *
 * Sin este archivo Laravel recurre a los mensajes en inglés incorporados en el
 * framework (vendor/.../Translation/lang/en/validation.php) — es decir, incluso
 * con la interfaz en español todos los errores de formulario aparecerían en
 * inglés. Como el cargador consulta primero resources/lang/es, este archivo los
 * sobrescribe.
 *
 * Español neutro (es-ES), registro cercano de "tú" (sin "vosotros"), igual que
 * resources/lang/es/app.php. Las frases usan la construcción "El campo
 * :attribute…" para que funcionen con cualquier nombre de campo, sea masculino
 * o femenino.
 *
 * Los nombres traducidos de los campos están en el array 'attributes' del final.
 */
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ha aparecido en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    /*
     * Mensajes específicos por regla: 'nombre_del_campo.regla' => 'mensaje'
     */
    'custom' => [
        'attribute-name' => [
    ...
    /*
     * Nombres de los campos en español. El :attribute de los mensajes se
     * sustituye por estos valores, de modo que en lugar de "El campo email es
     * obligatorio" se lea "El campo Correo electrónico es obligatorio".
     * Recopilados a partir de los formularios de la aplicación.
     */
    'attributes' => [
        'name' => 'Nombre',
        'first_name' => 'Nombre',
        ...
        'teacher_id' => 'Profesor',
        'teacher_class_id' => 'Clase',
        'user_id' => 'Usuario',
        'parent_id' => 'Elemento superior',
