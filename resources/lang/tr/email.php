...
return [
    ...
    'first_exercise_teacher' => [
        'subject' => '{{user_first_name}}, ilk öğrencini ekle 👥',
        'preheader' => 'Öğretmen panelin hazır — tek eksik öğrenciler',
        'title' => 'İlk öğrencine hazır mısın?',
        'p1' => '{{app_name}} öğretmen hesabını birkaç gün önce açtın ama henüz hiç öğrenci katılmadı. Davet etmek bir dakika sürüyor: bağlantıyı gönder, öğrencinin çalışmaları, ödevleri ve ilerlemesi doğrudan paneline düşsün.',
        'btn' => '👥 İlk Öğrencini Davet Et',
        'btn_sub' => 'Tek bağlantı. İlerlemesi otomatik görünür.',
        'p2' => 'Zaten başka yerde ders veriyor musun? Mevcut öğrencilerini buraya taşı — onlar çalışmaya devam etsin, veriler sende olsun.',
    ],

    'first_exercise_school' => [
        'subject' => '{{user_first_name}}, ilk öğretmenini ekle 🏫',
        'preheader' => 'Okul panelin hazır — tek eksik öğretmenler',
        'title' => 'İlk öğretmenine hazır mısın?',
        'p1' => '{{app_name}} okul hesabını birkaç gün önce açtın ama kadroda henüz hiç öğretmen yok. Birini davet et; onun öğrencileri, dersleri ve ilerlemesi otomatik olarak okul paneline aksın.',
        'btn' => '🏫 İlk Öğretmenini Davet Et',
        'btn_sub' => 'Tek bağlantı. Stüdyosu okuluna bağlanır.',
        'p2' => 'Eklediğin her öğretmen öğrencilerini de beraberinde getirir — tüm okulun tek ekranda.',
    ],

    'learning_path_teacher' => [
        'subject' => 'Öğrencilerin seni bekliyor, {{user_first_name}} 📋',
        'preheader' => 'Stüdyona bir göz at — ilerleme birikiyor',
        'title' => 'Stüdyon sensiz de devam etti',
        'p1' => 'Senin tarafında sakin bir hafta geçti ama öğrencilerin çalışmayı sürdürdü. Oturumları, doğruluk oranları ve serileri panelinde seni bekliyor — çoğu zaman tek bir ödev, tıkanan bir öğrenciyi eşiğin ötesine taşımaya yetiyor.',
        'btn' => '📋 Öğrencilerine Göz At',
        'btn_sub' => 'Kim ilerliyor, kim takıldı gör.',
        'p2' => '🎯 Bugün gönderilen kısa bir ödev, gelecek ay gönderilen uzun bir ödevden daha değerlidir.',
    ],

    'learning_path_school' => [
        'subject' => 'Okulun devam etti, {{user_first_name}} 📋',
        'preheader' => 'Öğretmenlerin ve öğrencilerin hareketliydi',
        'title' => 'Okulun sensiz de devam etti',
        'p1' => 'Bir haftadır uğramadın ama öğretmenlerin ve onların öğrencileri çalışmayı sürdürdü. Ders hareketliliği, öğrenci ilerlemesi ve öğretmen kadrosu okul panelinde güncel şekilde duruyor.',
        'btn' => '📋 Okul Panelini Aç',
        'btn_sub' => 'Her öğretmen, her öğrenci, tek ekran.',
        'p2' => '🎯 Haftada bir atılacak kısa bir bakış, kimin desteğe ihtiyacı olduğunu görmeye genelde yeter.',
    ],

    'weekly_progress_teacher' => [
        'subject' => 'Bu hafta stüdyon: {{weekly_sessions}} oturum 📈',
        'preheader' => 'Öğrencilerin bu hafta nasıl çalıştı',
        'title' => 'Bu hafta stüdyon',
        'subtitle' => 'Öğrencilerin bu hafta böyle çalıştı, {{user_first_name}}. Sen de {{weekly_assignments}} yeni ödev gönderdin.',
        'm1' => 'Öğrenci',
        'm2' => 'Oturum',
        'm3' => 'Doğruluk',
        'btn' => '📈 Öğretmen Panelini Aç',
        'btn_sub' => 'Kim ilerledi, kimin dürtülmeye ihtiyacı var incele.',
    ],

    'weekly_progress_school' => [
        'subject' => 'Bu hafta okulun: {{weekly_sessions}} oturum 📈',
        'preheader' => 'Okulun bu hafta nasıl çalıştı',
        'title' => 'Bu hafta okulun',
        'subtitle' => 'Okulundaki haftanın özeti, {{user_first_name}} — ortalama doğruluk {{weekly_accuracy}}.',
        'm1' => 'Öğretmen',
        'm2' => 'Öğrenci',
        'm3' => 'Oturum',
        'btn' => '📈 Okul Panelini Aç',
        'btn_sub' => 'Öğretmen ve öğrenci bazlı dökümler içeride.',
    ],

    're_engagement_teacher' => [
        'subject' => 'Öğretmen hesabın hâlâ burada, {{user_first_name}} 🎓',
        'preheader' => 'Öğrencilerin, ödevlerin ve profilin duruyor',
        'title' => 'Her şey bıraktığın yerde',
        'p1' => '{{app_name}} öğretmen panelini açmayalı bir süre oldu. Öğrenci listen, ödevlerin, profilin ve değerlendirmelerin tam bıraktığın gibi duruyor — hiçbiri silinmedi, hiçbiri kaybolmadı.',
        'btn' => '🎓 Öğretmeye Geri Dön',
        'btn_sub' => 'Stüdyona tek tıkla devam et.',
    ],

    're_engagement_school' => [
        'subject' => 'Okul hesabın hâlâ burada, {{user_first_name}} 🏫',
        'preheader' => 'Öğretmenlerin, öğrencilerin ve ayarların duruyor',
        'title' => 'Her şey bıraktığın yerde',
        'p1' => '{{app_name}} okul panelini açmayalı bir süre oldu. Öğretmen kadron, öğrenci kayıtların ve okul profilin tam bıraktığın gibi duruyor — hiçbiri silinmedi, hiçbiri kaybolmadı.',
        'btn' => '🏫 Okuluna Geri Dön',
        'btn_sub' => 'Okulun kaldığı yerden devam etsin.',
    ],

    'premium_upsell_teacher' => [
        'subject' => 'Stüdyon ücretsiz planı aştı, {{user_first_name}} ⭐',
        'preheader' => 'Premium ile randevu, ödeme ve sınırsız ödev',
        'badge' => '⭐ ÖĞRETMEN PREMIUM',
        'title' => 'Gerçek bir stüdyo kuruyorsun',
        'subtitle' => 'Merhaba {{user_first_name}} — düzenli çalışan öğrencilerin var. Premium, kurduğun bu stüdyoya şunları ekliyor:',
        'f1_t' => 'Çevrim içi randevu takvimi',
        'f1_d' => 'Öğrenciler boş saatlerinden ders alsın. Karşılıklı mesajlaşmaya gerek kalmasın.',
        'f2_t' => 'Sınırsız ödev',
        'f2_d' => 'Öğrencilerinin ihtiyacı kadar özel egzersiz gönder, günlük sınır yok.',
        'f3_t' => 'Öne çıkan herkese açık profil',
        'f3_d' => 'Öğretmen rehberinde üst sıralara çık ve profilin üzerinden ödeme al.',
        'btn' => '⭐ Öğretmen Planlarını Gör',
        'btn_sub' => 'Zaten ders veren öğretmenler için tasarlandı.',
        'p2' => 'Henüz hazır değil misin? Ücretsiz hesabın bugünkü gibi çalışmaya devam eder.',
    ],

    'premium_upsell_school' => [
        'subject' => 'Okulun ücretsiz planı aştı, {{user_first_name}} ⭐',
        'preheader' => 'Premium ile sınırsız öğretmen, okul markası ve raporlama',
        'badge' => '⭐ OKUL PREMIUM',
        'title' => 'Okulun büyüyor',
        'subtitle' => 'Merhaba {{user_first_name}} — öğretmenlerin aktif, öğrencileri çalışıyor. Premium şunları ekliyor:',
        'f1_t' => 'Kadroda sınırsız öğretmen',
        'f1_d' => 'Tüm eğitim kadronu kişi başı sınır olmadan ekle.',
        'f2_t' => 'Okul geneli raporlama',
        'f2_d' => 'Öğretmenleri ve sınıfları karşılaştır, veliler için ilerleme raporu dışa aktar.',
        'f3_t' => 'Markalı okul profili',
        'f3_d' => 'Kendi logon, kendi sayfan ve okul rehberinde üst sıralar.',
        'btn' => '⭐ Okul Planlarını Gör',
        'btn_sub' => 'Gerçek bir kadrosu olan okullar için tasarlandı.',
        'p2' => 'Henüz hazır değil misin? Ücretsiz hesabın bugünkü gibi çalışmaya devam eder.',
    ],
