...
return [
    ...
    'first_exercise_teacher' => [
        'subject' => '{{user_first_name}}, ajoute ton premier élève 👥',
        'preheader' => 'Ton tableau de bord professeur est prêt — il ne manque que les élèves',
        'title' => 'Prêt pour ton premier élève ?',
        'p1' => 'Tu as ouvert ton compte professeur {{app_name}} il y a quelques jours, mais aucun élève ne t\'a encore rejoint. Une invitation prend une minute : envoie le lien, et sa pratique, ses devoirs et sa progression arrivent directement dans ton tableau de bord.',
        'btn' => '👥 Inviter ton premier élève',
        'btn_sub' => 'Un lien. Sa progression apparaît automatiquement.',
        'p2' => 'Tu enseignes déjà ailleurs ? Fais venir tes élèves actuels : ils continuent à travailler, tu récupères les données.',
    ],

    'first_exercise_school' => [
        'subject' => '{{user_first_name}}, ajoute ton premier professeur 🏫',
        'preheader' => 'Ton tableau de bord école est prêt — il ne manque que les professeurs',
        'title' => 'Prêt pour ton premier professeur ?',
        'p1' => 'Tu as ouvert ton compte école {{app_name}} il y a quelques jours, mais aucun professeur ne figure encore dans l\'équipe. Invites-en un, et ses élèves, ses cours et sa progression remonteront automatiquement dans le tableau de bord de ton école.',
        'btn' => '🏫 Inviter ton premier professeur',
        'btn_sub' => 'Un lien. Son studio se connecte à ton école.',
        'p2' => 'Chaque professeur ajouté amène ses élèves avec lui : toute ton école dans une seule vue.',
    ],

    'learning_path_teacher' => [
        'subject' => 'Tes élèves t\'attendent, {{user_first_name}} 📋',
        'preheader' => 'Jette un œil à ton studio — la progression s\'accumule',
        'title' => 'Ton studio a continué sans toi',
        'p1' => 'La semaine a été calme de ton côté, mais tes élèves ont continué à travailler. Leurs sessions, leur précision et leurs séries t\'attendent dans le tableau de bord — et un seul devoir suffit souvent à débloquer quelqu\'un.',
        'btn' => '📋 Voir tes élèves',
        'btn_sub' => 'Vois qui progresse et qui bloque.',
        'p2' => '🎯 Un devoir court envoyé aujourd\'hui vaut mieux qu\'un long envoyé le mois prochain.',
    ],

    'learning_path_school' => [
        'subject' => 'Ton école a continué, {{user_first_name}} 📋',
        'preheader' => 'Tes professeurs et tes élèves ont été actifs',
        'title' => 'Ton école a continué sans toi',
        'p1' => 'Tu n\'es pas passé depuis une semaine, mais tes professeurs et leurs élèves ont continué à travailler. L\'activité des cours, la progression des élèves et la liste des professeurs sont à jour dans le tableau de bord de ton école.',
        'btn' => '📋 Ouvrir le tableau de bord école',
        'btn_sub' => 'Chaque professeur, chaque élève, une seule vue.',
        'p2' => '🎯 Un coup d\'œil hebdomadaire suffit généralement à repérer qui a besoin d\'aide.',
    ],

    'weekly_progress_teacher' => [
        'subject' => 'Ton studio cette semaine : {{weekly_sessions}} sessions 📈',
        'preheader' => 'Comment tes élèves ont travaillé cette semaine',
        'title' => 'Ton studio cette semaine',
        'subtitle' => 'Voici comment tes élèves ont travaillé cette semaine, {{user_first_name}}. Tu as envoyé {{weekly_assignments}} nouveaux devoirs.',
        'm1' => 'Élèves',
        'm2' => 'Sessions',
        'm3' => 'Précision',
        'btn' => '📈 Ouvrir le tableau de bord professeur',
        'btn_sub' => 'Regarde qui a progressé et qui a besoin d\'un coup de pouce.',
    ],

    'weekly_progress_school' => [
        'subject' => 'Ton école cette semaine : {{weekly_sessions}} sessions 📈',
        'preheader' => 'Comment ton école a travaillé cette semaine',
        'title' => 'Ton école cette semaine',
        'subtitle' => 'Voici la semaine dans ton école, {{user_first_name}} — précision moyenne {{weekly_accuracy}}.',
        'm1' => 'Professeurs',
        'm2' => 'Élèves',
        'm3' => 'Sessions',
        'btn' => '📈 Ouvrir le tableau de bord école',
        'btn_sub' => 'Détails par professeur et par élève à l\'intérieur.',
    ],

    're_engagement_teacher' => [
        'subject' => 'Ton compte professeur est toujours là, {{user_first_name}} 🎓',
        'preheader' => 'Tes élèves, tes devoirs et ton profil sont conservés',
        'title' => 'Tout est là où tu l\'as laissé',
        'p1' => 'Cela fait un moment que tu n\'as pas ouvert ton tableau de bord professeur {{app_name}}. Ta liste d\'élèves, tes devoirs, ton profil et tes avis sont exactement comme tu les as laissés — rien n\'a expiré, rien n\'est perdu.',
        'btn' => '🎓 Reprendre l\'enseignement',
        'btn_sub' => 'Retrouve ton studio en un clic.',
    ],

    're_engagement_school' => [
        'subject' => 'Ton compte école est toujours là, {{user_first_name}} 🏫',
        'preheader' => 'Tes professeurs, tes élèves et tes réglages sont conservés',
        'title' => 'Tout est là où tu l\'as laissé',
        'p1' => 'Cela fait un moment que tu n\'as pas ouvert le tableau de bord de ton école {{app_name}}. Ton équipe de professeurs, tes dossiers d\'élèves et le profil de ton école sont exactement comme tu les as laissés — rien n\'a expiré, rien n\'est perdu.',
        'btn' => '🏫 Revenir à ton école',
        'btn_sub' => 'Reprends là où ton école s\'était arrêtée.',
    ],

    'premium_upsell_teacher' => [
        'subject' => 'Ton studio a dépassé le plan gratuit, {{user_first_name}} ⭐',
        'preheader' => 'Réservations, paiements et devoirs illimités avec Premium',
        'badge' => '⭐ PREMIUM PROFESSEUR',
        'title' => 'Tu construis un vrai studio',
        'subtitle' => 'Bonjour {{user_first_name}} — tes élèves travaillent régulièrement. Voici ce que Premium ajoute au studio que tu as déjà bâti :',
        'f1_t' => 'Calendrier de réservation en ligne',
        'f1_d' => 'Les élèves réservent leurs cours sur tes créneaux libres. Fini les échanges de messages.',
        'f2_t' => 'Devoirs illimités',
        'f2_d' => 'Envoie autant d\'exercices personnalisés que tes élèves en ont besoin, sans limite quotidienne.',
        'f3_t' => 'Un profil public mis en avant',
        'f3_d' => 'Monte dans l\'annuaire des professeurs et encaisse les paiements depuis ton profil.',
        'btn' => '⭐ Voir les offres professeur',
        'btn_sub' => 'Conçu pour les professeurs qui enseignent déjà.',
        'p2' => 'Pas encore prêt ? Ton compte gratuit continue de fonctionner exactement comme aujourd\'hui.',
    ],

    'premium_upsell_school' => [
        'subject' => 'Ton école a dépassé le plan gratuit, {{user_first_name}} ⭐',
        'preheader' => 'Professeurs illimités, image de marque et rapports avec Premium',
        'badge' => '⭐ PREMIUM ÉCOLE',
        'title' => 'Ton école grandit',
        'subtitle' => 'Bonjour {{user_first_name}} — tes professeurs sont actifs et leurs élèves travaillent. Voici ce qu\'ajoute Premium :',
        'f1_t' => 'Professeurs illimités dans l\'équipe',
        'f1_d' => 'Ajoute toute ton équipe pédagogique sans limite de places.',
        'f2_t' => 'Rapports à l\'échelle de l\'école',
        'f2_d' => 'Compare les professeurs et les groupes, et exporte la progression pour les familles.',
        'f3_t' => 'Un profil d\'école à ton image',
        'f3_d' => 'Ton logo, ta page et un meilleur classement dans l\'annuaire des écoles.',
        'btn' => '⭐ Voir les offres école',
        'btn_sub' => 'Conçu pour les écoles avec une vraie équipe.',
        'p2' => 'Pas encore prêt ? Ton compte gratuit continue de fonctionner exactement comme aujourd\'hui.',
    ],
