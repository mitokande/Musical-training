...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6"
        x-data="{ code: '{{ old('code') }}' }">
        @csrf
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t">
            ...
            <button type="submit" class="inline-flex items-center gap-2 px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                <i data-lucide="save" class="w-4 h-4"></i> Create Coupon
            </button>
        </div>
    </form>
</div>
