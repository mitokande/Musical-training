...
@section('page-title', 'Edit Content Category')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.content-categories.update', $category) }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
        @csrf
        @method('PUT')
