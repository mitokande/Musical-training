    ...
    <form action="{{ route('admin.interval-construction.update', $practice) }}" method="POST" class="card p-6 space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <select name="note1" id="note1" x-model="note1" class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" required>
            ...
            <div>
                ...
                <select name="note2" id="note2" x-model="note2" class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" required>
                    @foreach (['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B'] as $note)
        ...
        <div>
            ...
            <select name="octave" id="octave" x-model.number="octave1" class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" required>
