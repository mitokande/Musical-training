...
@section('page-title', 'Edit: ' . $exercise->title)
...
<div class="max-w-5xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Edit Exercise</h2>
    </div>
    ...
    <form method="POST" action="{{ route('admin.learning-path-exercises.update', $exercise) }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
        @csrf @method('PUT')
        @include('admin.learning-path-exercises._form', ['ex' => $exercise])
