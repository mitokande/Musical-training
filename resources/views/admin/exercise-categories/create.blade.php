...
@section('page-title', 'Create Exercise Category')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Create Exercise Category</h2>
    </div>

    <form action="{{ route('admin.exercise-categories.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
        @csrf
