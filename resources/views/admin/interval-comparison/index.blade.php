    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Interval Comparison Practices</h1>
            </div>
            <p class="text-gray-500">Manage interval comparison recognition questions</p>
        </div>
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Interval A</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Interval B</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Larger</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full {{ $practice->target === 'a' ? 'bg-orange-100 text-orange-700' : 'bg-gray-100 text-gray-700' }} text-sm font-semibold">
                            {{ $practice->interval_a }}
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full {{ $practice->target === 'b' ? 'bg-orange-100 text-orange-700' : 'bg-gray-100 text-gray-700' }} text-sm font-semibold">
                            {{ $practice->interval_b }}
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-100 text-green-700 text-sm font-bold uppercase">
                            {{ $practice->target }}
                        </span>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            <a href="{{ route('admin.interval-comparison.edit', $practice) }}" 
                               class="p-2 text-gray-500 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors">
                                <i data-lucide="pencil" class="w-4 h-4"></i>
                            </a>
                            <form action="{{ route('admin.interval-comparison.destroy', $practice) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this practice?')">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 mb-2">No interval comparison practices found.</p>
                            <a href="{{ route('admin.interval-comparison.create') }}" class="text-purple-600 hover:text-purple-700 font-medium">
