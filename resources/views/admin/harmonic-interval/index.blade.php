    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Harmonic Interval Practices</h1>
            </div>
            <p class="text-gray-500">Manage harmonic interval recognition questions (notes played simultaneously)</p>
        </div>
        <a href="{{ route('admin.harmonic-interval.create') }}" 
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        @php
                            $vs = $practice->validation_status ?? app(\App\Services\MusicTheoryService::class)->validateQuestionConsistency($practice->toArray(), 'harmonic-interval-practice')['status'];
                        @endphp
                        @if ($vs === 'valid')
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            <a href="{{ route('admin.harmonic-interval.edit', $practice) }}" 
                               class="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <i data-lucide="pencil" class="w-4 h-4"></i>
                            </a>
                            <form action="{{ route('admin.harmonic-interval.destroy', $practice) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this practice?')">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 mb-2">No harmonic interval practices found.</p>
                            <a href="{{ route('admin.harmonic-interval.create') }}" class="text-blue-600 hover:text-blue-700 font-medium">
