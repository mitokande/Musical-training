...
@section('content')
<div class="max-w-2xl" x-data="intervalEditor('C', 4, 'E', 4)">
    <!-- Header -->
    <div class="mb-8">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <select name="note1"
                    ...
                    <option value="{{ $note }}" {{ old('note1', 'C') == $note ? 'selected' : '' }}>{{ $note }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="note2"
                        ...
                        required>
                    @foreach (['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B'] as $note)
                    <option value="{{ $note }}" {{ old('note2', 'E') == $note ? 'selected' : '' }}>{{ $note }}</option>
                    @endforeach
                </select>
