    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Melodic Interval Practices</h1>
            </div>
            <p class="text-gray-500">Manage melodic interval recognition questions (notes played sequentially)</p>
        </div>
        <a href="{{ route('admin.melodic-interval.create') }}" 
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            <a href="{{ route('admin.melodic-interval.edit', $practice) }}" 
                               class="p-2 text-gray-500 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors">
                                <i data-lucide="pencil" class="w-4 h-4"></i>
                            </a>
                            <form action="{{ route('admin.melodic-interval.destroy', $practice) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this practice?')">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 mb-2">No melodic interval practices found.</p>
                            <a href="{{ route('admin.melodic-interval.create') }}" class="text-purple-600 hover:text-purple-700 font-medium">
