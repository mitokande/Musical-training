    ...
    <main wire:id="practice-harmonic-interval-{{ $currentPracticeIndex }}" class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="card overflow-hidden mb-6">
            ...
            <div class="hero-gradient p-6">
                <div class="relative flex items-center justify-center">
                    ...
                    <div class="flex items-center gap-4 text-center">
                        <div>
                            <h1 class="text-xl font-bold text-white">{{ __('app.practice_ui.harmonic_interval.title') }}</h1>
                            <p class="text-white/80 text-sm">{{ __('app.practice_ui.harmonic_interval.subtitle') }}</p>
                        </div>
                    </div>
            ...
            <div class="p-4 sm:p-8">
                <!-- Exercise title -->
                <p class="text-center text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">{{ __('app.practice_ui.harmonic_interval.label') }}</p>
            ...
            window.initPracticeHarmonicInterval = function() {
                ...
                if (playButton && answerOptions) {
                    ...
                    playButton.onclick = async function() {
                        ...
                        playStatus.textContent = pt('playing_harmonic');
                        if (typeof lucide !== 'undefined') lucide.createIcons();
