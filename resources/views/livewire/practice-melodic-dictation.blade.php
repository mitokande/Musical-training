<div>
    ...
    <style>
        .md-dur-btn {
            ...
            background:#0d9488; color:white; border:2px solid transparent;
            display:flex; align-items:center; justify-content:center;
            cursor:pointer; transition:background 0.12s, border-color 0.12s, box-shadow 0.12s;
        }
        .md-dur-btn:hover { background:#065f46; }
        .md-dur-btn:active { background:#022c22; }
        .md-dur-btn.md-selected {
            background:#042f2e; border-color:#34d399;
        ...
        .md-note-btn:hover { border-color:#a78bfa; background:#f5f3ff; }
        .md-note-btn.md-flash { background:#7c3aed; color:white; border-color:#7c3aed; transform:scale(0.93); }
        .md-oct-btn {
        ...
        .md-acc-btn.md-acc-active { background:#7c3aed; border-color:#a78bfa; box-shadow:0 0 0 2px rgba(167,139,250,0.3); }
        .md-act-btn {
        ...
        .md-seg-dot.active { background:#0d9488; }
    ...
    <main class="max-w-4xl mx-auto px-1 sm:px-6 lg:px-8 pt-3.5 pb-6">
        ...
        <div class="card overflow-hidden mb-6">
            ...
            <div class="p-2.5 sm:p-6">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div class="min-w-0 flex-1" style="min-width:42%">
                            ...
                            <div class="bg-gray-200 rounded-full overflow-hidden" style="height:6px;width:50%">
                                <div id="beatProgress" class="bg-amber-400 h-full rounded-full transition-all duration-150" style="width:0%"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex-shrink-0" style="min-width:150px;">
                            <button id="playButton"
                                style="background:linear-gradient(135deg,#16a34a 0%,#22c55e 100%);transition:all 0.2s;width:100%;"
                            ...
                            @if ($currentPracticeIndex < (count($practices) - 1))
                                <button id="nextPracticeBtn" x-on:click="$wire.getNextPractice()"
                                    class="font-semibold py-3 px-6 rounded-xl items-center justify-center gap-2 bg-blue-100 text-blue-700 border-2 border-blue-300 hover:bg-blue-200"
                ...
                <div class="flex flex-wrap gap-2 mb-1 md-action-bar">
                    ...
                    <button id="nextSegBtn" class="md-act-btn" style="display:none;background:linear-gradient(135deg,#0d9488,#14b8a6);color:white;border-color:transparent;">
                        <i data-lucide="arrow-right" class="w-4 h-4"></i> Next Segment
                    </button>
                    <!-- Play from start (shown after all segments answered) -->
                    <button id="playFullPiece" class="md-act-btn" style="display:none;background:linear-gradient(135deg,#7c3aed,#a78bfa);color:white;border-color:transparent;">
        ...
        }; // end initPracticeMelodicDictation
