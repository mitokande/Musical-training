        ...
        <div class="card overflow-hidden mb-6">
            ...
            <div class="p-8">
                ...
                <div id="noteVisualPlaceholder" class="w-full h-32 bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center mb-8">
                    <x-notechart :target="strtolower($currentPractice->target) . '/' . $currentPractice->octave" />
                </div>
                ...
                <div class="card p-6 mb-8">
                    <div class="flex flex-col items-center">
                        <button 
                            ...
                            data-note="{{ $currentPractice->target }}{{ $currentPractice->octave }}"
                        >
                ...
                <!-- Answer Options -->
                <div id="answerOptions" class="grid grid-cols-2 gap-4" data-target="{{ $currentPractice->target }}">
