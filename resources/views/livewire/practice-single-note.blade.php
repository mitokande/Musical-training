        ...
        <div class="card overflow-hidden mb-6">
            ...
            <div class="p-8">
                ...
                <div id="noteVisualPlaceholder" class="w-full h-32 bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center mb-8">
                    {{ $currentPractice->target }} {{ $currentPractice->octave }}
                    {{-- <x-notechart :target="strtolower($currentPractice->note1) . '/' . $currentPractice->octave . ',' . $currentPractice->note2 . '/' . $currentPractice->octave" /> --}}
                        <div>
                            ...
                            <div id="output" style="width: 400px; height: 200px;" data-notes="{{ strtolower($currentPractice->target) . '/' . $currentPractice->octave }}"></div>
                ...
                <div class="card p-6 mb-8">
                    <div class="flex flex-col items-center">
                        <div class="flex">
                            ...
                            data-note="{{ strtoupper($currentPractice->target) . $currentPractice->octave }}"
                        >
                ...
                <div id="answerOptions" class="grid grid-cols-2 gap-4" 
                    ...
                    @foreach(explode(',', $currentPractice->other_options) as $option)
            ...
            window.initPracticeSingleNote = function() {
                ...
                if (playButton && answerOptions) {
                    ...
                    playButton.onclick = function() {
                        ...
                        // When first note ends, reset button
