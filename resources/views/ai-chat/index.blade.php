...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-bold text-gray-900">{{ __('app.home_ui.ai_ask_title') }}</h1>
            ...
            <div class="rounded-2xl overflow-hidden shadow-sm">
                <div class="bg-gradient-to-br from-purple-600 to-indigo-600 p-5 text-white">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h3 class="font-bold text-lg leading-tight">{{ __('app.home_ui.ai_coach') }}</h3>
                            <p class="text-white/70 text-xs">{{ __('app.home_ui.ai_weekly_plan') }}</p>
                        </div>
                    </div>
                    <p class="text-white/85 text-sm mb-4 leading-relaxed">{{ __('app.home_ui.ai_weekly_desc') }}</p>
